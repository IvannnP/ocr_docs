...
**УПД, счета, акты, накладные, договоры.**
...
- исследовать современные методы OCR и VLLM модели
...
- изучить дополнительные бизнес-задачи, которые можно решать на этапе распознавания документа
